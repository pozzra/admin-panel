<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  <div class="flex justify-between items-center mb-4">
                                      <h1 class="text-2xl font-bold mb-4">Slide Management</h1>
                                      ...
                                      <form method="POST" action="{{ route('logout') }}" x-data="{ open: false }">
                                         ...
                                         <div x-show="open" class="fixed inset-0  flex items-center justify-center z-50">
                                              <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
                                                <input  type="text"  name="name" placeholder="name" class="border rounded px-3 py-3 w-2/4 bg-white dark:bg-gray-800 " style="width: 300px; padding: 10px;">
                                                <input type="file" name="Image" placeholder="Image" class="border rounded px-3 py-2 w-1/4 bg-white dark:bg-gray-800 " style="width: 300px; border: 1px solid gray;">
 ...
 <thead >
    <tr>
      ...
      <th class="bg-gray-100 dark:bg-gray-700 px-2 py-2">Image</th>
...
<tbody>         
 ...
 {{-- @foreach ($users as $user) --}}
    <tr class=" dark:border-gray-600">
      ...
      <td class="px-4 py-2">
      <img width="50" height="auto" src="https://img.freepik.com/free-vector/shop-with-sign-we-are-open_52683-38687.jpg?semt=ais_hybrid&w=740" alt="Slide Image" class="object-cover rounded" id="slide-image" >
       
      </td>
        <td class="px-4 py-4 flex justify-around" >
        {{-- <a href="{{ route('admin.show', $user->id) }}" class="text-blue-500 hover:text-blue-700">View</a> --}}
    ...
    {{-- @endforeach --}}
        ...
        {{-- if click on image please popup image size center  screen background blur --}} 
        <style>
          table {
...
document.getElementById('slide-image').addEventListener('click', function() {
    const popup = document.getElementById('slide-image-popup');
