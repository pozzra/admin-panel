<x-app-layout>
                                      ...
                                      <form method="POST" action="{{ route('logout') }}" x-data="{ open: false }">
                                         ...
                                         <div x-show="open" class="fixed inset-0  flex items-center justify-center z-50">
                                              <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
                                                <input  type="text"  name="username" placeholder="Username" class="border rounded px-3 py-2 w-1/4 bg-white dark:bg-gray-800 ">
                                         <input type="email" name="email" placeholder="Email" class="border rounded px-3 py-2 w-1/4 bg-white dark:bg-gray-800 ">
                                         <select name="role" class="border rounded px-3 py-2 w-1/4 bg-white dark:bg-gray-800 ">
                                             <option  value="">Select Role</option>
                                             <option value="admin">Admin</option>
                                            <option value="user">User</option>
                                         </select>
                                          <input type="text" name="password" placeholder="Password" class="border rounded px-3 py-2 w-1/4 bg-white dark:bg-gray-800 ">
 ...
 <thead >
    <tr>
      ...
      <th class="bg-gray-100 dark:bg-gray-700 px-2 py-2">Username</th>
      <th class="bg-gray-100 dark:bg-gray-700 px-2 py-2">Email</th>
      <th class="bg-gray-100 dark:bg-gray-700 px-2 py-2">Role</th>
      <th class="bg-gray-100 dark:bg-gray-700 px-2 py-2">Password</th>
...
<tbody>         
    ...
    <tr class="border-b dark:border-gray-600">
      ...
      <td class="px-4 py-2">admin1</td>
      <td class="px-4 py-2">admin1@example.com</td>
